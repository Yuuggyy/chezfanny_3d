    ...
    <div style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 4 }}>
          ...
          <span style={{ flex: 1, borderBottom: `1.5px dotted rgba(232,160,180,0.30)`, position: 'relative', top: -3, minWidth: 8 }} />
  ...
  return (
    <div ref={wrapperRef} onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
      ...
      <div style={{
        ...
        {pages.map((p, i) => (
          <button key={i} onClick={() => setCurrent(i)} style={{
            ...
            transition: 'all 0.2s',
            boxShadow: i === current ? `0 2px 10px rgba(232,160,180,0.30)` : 'none',
          }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: 6, marginBottom: 14 }}>
        {pages.map((_, i) => (
          <div key={i} onClick={() => setCurrent(i)} style={{
            ...
            background: i === current ? C.gold : `rgba(232,160,180,0.25)`,
      ...
      <div style={{
        ...
        boxShadow: `0 4px 20px rgba(123,58,90,0.08)`,
        overflow: 'hidden',
      }}>
        {/* Header catégorie */}
        <div style={{
