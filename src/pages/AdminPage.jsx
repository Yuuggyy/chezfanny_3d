...
const C = {
  ...
  danger:      '#C0392B',
  warning:     '#D4891A',
  goldDeep:    '#CE3560', // high-contrast accent for text on white/cream backgrounds
      ...
      <div style={{ width: '100%', maxWidth: 420 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 44 }}>
          <div style={{
            ...
            boxShadow: `0 8px 32px rgba(232,160,180,0.35)`,
          }}>
        ...
        <div style={{
          ...
          <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            <div>
              ...
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} required autoFocus
                style={{
                  ...
                  background: 'rgba(255,255,255,0.07)', border: `1.5px solid rgba(232,160,180,0.25)`,
                  borderRadius: 12, color: C.beige, fontSize: 15, fontFamily: 'inherit',
                  outline: 'none', transition: 'border-color 0.2s',
                }}
                onFocus={e => e.target.style.borderColor = C.gold}
                onBlur={e => e.target.style.borderColor = 'rgba(232,160,180,0.25)'}
              />
            </div>
            <div>
              <label style={{ display: 'block', fontSize: 11, fontWeight: 600, color: C.gold, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 8 }}>
            ...
            <button type="submit" disabled={loading} style={{
              ...
              boxShadow: `0 4px 20px rgba(232,160,180,0.4)`,
...
function CommandesTab() {
  ...
  const badgeStyle = (statut) => ({
    recue:     { bg: `rgba(232,160,180,0.15)`, color: C.goldDeep },
          ...
          {filtered.map(cmd => {
            ...
            return (
              <div key={cmd.id} style={{
                ...
                border: `1px solid ${C.border}`, boxShadow: `0 2px 10px rgba(123,58,90,0.06)`,
...
function ProduitsTab() {
  ...
  return (
    <div>
      ...
      {form && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(123,58,90,0.45)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: 20 }}>
          <div style={{ background: '#fff', borderRadius: 20, padding: 32, width: '100%', maxWidth: 480, boxShadow: '0 20px 60px rgba(123,58,90,0.2)' }}>
...
function CategoriesTab() {
  ...
  return (
    <div>
      ...
      {form && (
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(123,58,90,0.45)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: 20 }}>
          <div style={{ background: '#fff', borderRadius: 20, padding: 32, width: '100%', maxWidth: 400, boxShadow: '0 20px 60px rgba(123,58,90,0.2)' }}>
            <h3 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 22, color: C.primary, marginBottom: 24 }}>
...
function ParametresTab() {
  ...
  const cardStyle  = { background: '#fff', borderRadius: 16, border: `1px solid ${C.border}`, boxShadow: `0 2px 10px rgba(123,58,90,0.06)`, padding: 24, marginBottom: 20 };
    ...
    <div>
      ...
      <div style={cardStyle}>
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          <input value={nomRestaurant} onChange={e => setNom(e.target.value)} style={{ ...inputStyle, flex: 1, minWidth: 200 }} placeholder="Chez Fanny" />
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', background: C.cream }}>
      ...
      <aside style={{
        ...
        boxShadow: '4px 0 24px rgba(123,58,90,0.18)',
      }}>
        {/* Header sidebar */}
        <div style={{ padding: '0 24px 24px', borderBottom: `1px solid rgba(232,160,180,0.18)`, marginBottom: 12 }}>
          ...
          <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 20, color: C.beige, fontWeight: 700, lineHeight: 1.2 }}>Chez Fanny</h2>
        ...
        <nav style={{ flex: 1, padding: '0 12px', display: 'flex', flexDirection: 'column', gap: 4 }}>
          {TABS.map(t => (
            <button key={t.id} onClick={() => setTab(t.id)} style={{
              ...
              background: tab === t.id ? `rgba(232,160,180,0.18)` : 'transparent',
        ...
        {/* Footer sidebar */}
        <div style={{ padding: '12px 16px', borderTop: `1px solid rgba(232,160,180,0.12)`, display: 'flex', flexDirection: 'column', gap: 8 }}>
          <button onClick={() => window.open('/', '_blank')} style={{
            width: '100%', padding: '9px 14px', borderRadius: 10, border: `1px solid rgba(232,160,180,0.25)`,
