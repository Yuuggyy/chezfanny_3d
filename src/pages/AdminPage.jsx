    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center',
      ...
      <div style={{ width: '100%', maxWidth: 420 }}>
        <div style={{ textAlign: 'center', marginBottom: 44 }}>
          ...
          <h1 style={{ fontSize: 32, fontWeight: 700, color: '#FFF0F4', letterSpacing: '0.04em' }}>
            Chez Fanny
          </h1>
              ...
              <div key={lbl}>
                ...
                <input type={i === 0 ? 'email' : 'password'}
                  ...
                  style={{ width: '100%', padding: '13px 16px',
                    ...
                    borderRadius: 12, color: '#FFF0F4', fontSize: 15, fontFamily: 'inherit', outline: 'none',
                  }}
                />
              </div>
            ))}
          ...
          <div key={cmd.id} style={{ background:'#fff', borderRadius:14, padding:'18px 20px',
            ...
            <div style={{ display:'flex', gap:8, flexWrap:'wrap' }}>
              {STATUT_NEXT[cmd.statut] && <button onClick={()=>nextStatut(cmd)} style={{ padding:'7px 14px', borderRadius:8, border:'none', cursor:'pointer',
                background:`linear-gradient(135deg,${C.primary},${C.primaryMid})`, color:'#FFF0F4', fontSize:12, fontWeight:600 }}>
  ...
  return (
    <div>
      <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:24,flexWrap:'wrap',gap:12}}>
        ...
        <button onClick={openNew} style={{padding:'9px 18px',borderRadius:10,border:'none',cursor:'pointer',background:`linear-gradient(135deg,${C.primary},${C.primaryMid})`,color:'#FFF0F4',fontSize:13,fontWeight:600}}>+ Ajouter</button>
      </div>
      {loading?<div style={{display:'flex',justifyContent:'center',padding:60}}><div className="spinner"/></div>
    ...
    <div>
      ...
      <div style={crd}>
        ...
        <div style={{display:'flex',gap:12,flexWrap:'wrap'}}>
          <input value={nomRestaurant} onChange={e=>setNom(e.target.value)} style={{...inp,flex:1,minWidth:200}} placeholder="Chez Fanny"/>
      ...
      <div style={crd}>
        ...
        <div style={{display:'flex',flexDirection:'column',gap:12}}>
          ...
          <button onClick={handleChangePassword} disabled={pwdLoading} style={{padding:'12px 20px',borderRadius:10,border:'none',cursor:'pointer',background:`linear-gradient(135deg,${C.primary},${C.primaryMid})`,color:'#FFF0F4',fontWeight:700,fontSize:14,alignSelf:'flex-start'}}>{pwdLoading?'⏳ Modification…':'🔐 Mettre à jour'}</button>
        </div>
      </div>
    </div>
  );
    ...
    <div style={{display:'flex',minHeight:'100vh',background:'#FAFAFA'}}>
      <aside style={{width:230,flexShrink:0,background:C.primary,display:'flex',flexDirection:'column',padding:'28px 0',position:'fixed',top:0,left:0,bottom:0,zIndex:100,boxShadow:'4px 0 24px rgba(0,0,0,0.18)'}}>
        <div style={{padding:'0 24px 24px',borderBottom:'1px solid rgba(255,255,255,0.12)',marginBottom:12}}>
          ...
          <h2 style={{fontSize:18,color:'#FFF0F4',fontWeight:700,lineHeight:1.2}}>{"Chez Fanny"}</h2>
