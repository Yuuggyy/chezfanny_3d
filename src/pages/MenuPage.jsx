    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, minWidth: 0 }}>
          ...
          <div style={{ minWidth: 0 }}>
            ...
            }}>{parametres?.nom_restaurant || 'Chez Fanny'}</h1>
            {!isMobile && (
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, flexShrink: 0 }}>
          <button onClick={() => setShowAppel(true)} style={{
            ...
            border: '1px solid rgba(232,160,180,0.40)',
          ...
          <button onClick={() => setShowPanier(true)} style={{
            ...
            whiteSpace: 'nowrap',
            boxShadow: totalItems > 0 ? `0 4px 16px rgba(232,160,180,0.35)` : 'none',
          }}>
            🛒 {!isMobile && L.panier}
            {totalItems > 0 && (
              <span style={{
      ...
      {showAppel && (
        <div style={{
          ...
          background: 'rgba(123,58,90,0.50)', backdropFilter: 'blur(4px)',
          ...
          <div style={{
            ...
            boxShadow: '0 20px 60px rgba(123,58,90,0.25)',
      ...
      {toast && (
        <div style={{
          ...
          boxShadow: '0 8px 24px rgba(123,58,90,0.25)',
